...
! This version is intended for control via bashscript.
! This version has corrected angles (removed superfluous kxx factor)
program fieldmap
...
eta=3
!go from 0.1 to 5, dimensionless parameter equal to d/lambda
