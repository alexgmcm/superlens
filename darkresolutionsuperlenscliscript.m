...
print('-dpng',strcat('plots/darkim_res',num2str(thetamax),'degspieta',gs,'sigmatilde',num2str(eps2),'eps2',num2str(secondinterface),'secint.png'));
...
line([xi xf],[secondinterface secondinterface],'linewidth',4,'Color', 'k');
%line([xi xf],[0 0],'linewidth',4,'Color', 'k');
print('-dpng',strcat('plots/darkreal_res',num2str(thetamax),'degspieta',gs,'sigmatilde',num2str(eps2),'eps2',num2str(secondinterface),'secint.png'));
...
ylabel('Intensity (EE*)');
%ylim([0 7e-03])
print('-dpng',strcat('plots/darkimageprofile',num2str(thetamax),'degsthetamax.png'));
...
xlabel('x ,d_s');
ylabel('Intensity (EE*)');
print('-dpng',strcat('plots/darksourceprofile',num2str(thetamax),'degsthetamax.png'));
