...
gs=num2str(g, '%5.3f');
data(:,:,1) = load(strcat('data/darkres',num2str(thetamax, '%3.1f'),'degs','3.1eta',gs,'sigmatilde',num2str(secondinterface,'%2.1f'),'secint',num2str(etacutoff,'%2i'),'etalimit.dat'));
...
print('-dpng',strcat('plots/darkim_res',num2str(thetamax),'degspieta',gs,'sigmatilde',num2str(eps2),'eps2','kxcutoff',num2str(etacutoff,'%2i'),num2str(secondinterface),'secint.png'));
...
line([xi xf],[secondinterface secondinterface],'linewidth',4,'Color', 'k');
%line([xi xf],[0 0],'linewidth',4,'Color', 'k');
print('-dpng',strcat('plots/darkreal_res',num2str(thetamax),'degspieta',gs,'sigmatilde',num2str(eps2),'eps2','kxcutoff',num2str(etacutoff,'%2i'),num2str(secondinterface),'secint.png'));
...
print('-dpng',strcat('plots/darkeyrpprofileeta',eta,'kxcutoff',num2str(etacutoff,'%2i'),'.png'));
...
ylabel('Intensity (EE*)');
%ylim([0 7e-03])
print('-dpng',strcat('plots/darkimageprofile','kxcutoff',num2str(etacutoff,'%2i'),num2str(thetamax),'degsthetamax.png'));
...
xlabel('x ,d_s');
ylabel('Intensity (EE*)');
print('-dpng',strcat('plots/darksourceprofile','kxcutoff',num2str(etacutoff,'%2i'),num2str(thetamax),'degsthetamax.png'));
...
xlabel('x ,d_s');
ylabel('Intensity (EE*)');
print('-dpng',strcat('plots/darksecintprofile','kxcutoff',num2str(etacutoff,'%2i'),num2str(thetamax),'degsthetamax.png'));
...
xlabel('x ,d_s');
ylabel('Intensity (EE*)');
print('-dpng',strcat('plots/darkfirstintprofile','kxcutoff',num2str(etacutoff,'%2i'),num2str(thetamax),'degsthetamax.png'));
