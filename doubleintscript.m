...
for x=1:1
num2str(g(x), '%3.1f');
data(:,:,x) = load(strcat('data/doubint',thetai,'degs','3.1eta4.0sigmatilde.dat'));
end
...
print('-dpng',strcat('plots/im_doubint',thetai,'degspieta4.0sigmatilde',num2str(eps2),'eps2.png'));
...
line([xi xf],[11*dsource 11*dsource],'linewidth',4,'Color', 'k');
%line([xi xf],[0 0],'linewidth',4,'Color', 'k');
print('-dpng',strcat('plots/real_doubint',thetai,'degspieta4.0sigmatilde',num2str(eps2),'eps2.png'));
end
