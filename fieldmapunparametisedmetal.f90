...
double precision :: xi, zi, c=300000000, xf, zf, w, Eyout, PI, Eyout2, test
complex*16 :: Ey, Ie, Re, Ce, De, Te, kx, kz1, kz2, A, B, C2, D2, F, G, H, I2, J, K, i, eps1, eps2, mu1, mu2, n1, n2
integer :: m, n, p !, SIZE
...
do p=0, 0
	thetai = p*PI/12.0
	write(filename,20) thetai, '2micmetal3fieldmap.dat'
	print *, thetai
