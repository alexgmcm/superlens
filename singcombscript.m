function singcombscript(secondinterface, thetamax, etacutoff)
gs='0.001';
data(:,:,1) = load(strcat('data/singlinecombres',num2str(thetamax, '%3.1f'),'degs','3.1eta',gs,'sigmatilde',num2str(secondinterface,'%2.1f'),'secint',num2str(etacutoff,'%2i'),'etalimit.dat'));
x=data(:,1);
intensity=data(:,3);
...
%ylim([0 7e-03])
print('-dpng',strcat('plots/singlinecombimageprofile','kxcutoff',num2str(etacutoff,'%2i'),num2str(thetamax),'degsthetamax.png'));
hold off;
