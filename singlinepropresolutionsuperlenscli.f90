...
PROGRAM singlinepropresolutionsuperlenscli
...
write(filename,20) 'data/singlinepropres',thetamax,'degs',eta,'eta', sigmatilde,'sigmatilde',secondinterface,&
...
do m=0, ztildesize
	...
	print*, "ztilde: ", ztilde 
	ztilde=(nint(ztilde * 1000.0) * 1E-3)
	if (ztilde==4.0) then
		print*, "got here"
	do n=0, xtildesize
