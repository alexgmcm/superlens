...
title(strcat('normal plot of intensity, sigma=',gs,' ',string ));
colorbar;
%caxis([-10 20]);
...
print('-dpng',strcat('plots/',string,'2D',num2str(thetamax),'degspieta',gs,'sigmatilde',num2str(eps2),'eps2','kxcutoff',kxcutoff,num2str(secondinterface),'secint.png'));
